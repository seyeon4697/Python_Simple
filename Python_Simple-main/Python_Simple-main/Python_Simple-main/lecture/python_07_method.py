...
# - return만 사용하면 함수 호출문으오 None값 전달
...
# - 이렇게 특정코드블록에서 선언된 변수응 지역변수
# - 반대로 가장 상단에 정의 되어 프로그램 종료 전까지
#   유지되는 변수를 전역 변수
